(function() {
		...
		function banner() {
			...
			// Frame 1
			tl1.from('#frame1_mary', (dur * 4), {ease:Power2.easeOut, autoAlpha:0}, "frame1+=0.25")
			tl1.from('#frame1_sparkle', (dur * 4), {autoAlpha:0, delay: 0.75}, "frame1+=0.25")
			tl1.from('#frame1_blossom', (dur * 8), {ease:Power2.easeOut, autoAlpha:0}, "frame1+=0.5")
			tl1.from('#frame1_blossom', (dur * 12), {ease:Power2.easeOut, y:-20}, "frame1+=0.5")
			tl1.from('#frame1_tt', (dur * 4), {ease:Power2.easeOut, autoAlpha:0, y:-10}, "frame1+=0.75")
			tl1.from('#frame1_release', (dur * 4), {ease:Power2.easeOut, autoAlpha:0, y:-10}, "frame1+=1")
			tl1.from('#cta_exit', (dur * 4), {ease:Power2.easeOut, autoAlpha:0, y:-10}, "frame1+=1.25")
			tl1.from('#frame1_legal', (dur * 4), {ease:Power2.easeOut, autoAlpha:0}, "frame1+=1.5")
			;

			var tl2 = new TimelineMax({repeat:4});
			tl2.to('#frame1_sparkle', (dur * 12), {scale: 2, rotation:540, transformOrigin:"center center"}, "frame2")
			tl2.to('#frame1_sparkle', (dur * 12), {scale: 1, rotation:540, transformOrigin:"center center"}, "frame2+=3");
